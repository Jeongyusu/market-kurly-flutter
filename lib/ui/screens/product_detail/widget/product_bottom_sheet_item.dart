...
class ProductBottomSheetItem extends ConsumerWidget {
  final productId;
  const ProductBottomSheetItem({super.key, this.productId});
                                ...
                                RichText(
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text:
                                            "[ ${model!.productDescriptionDTO!.seller} ]",
                                        style: subContents(),
                                      ),
                                      WidgetSpan(
                                      ...
                                      TextSpan(
                                        text: model!
                                            .productDescriptionDTO!.productName,
                                        style: subContents(),
                                      ),
                                    ],
                                  ),
                    ...
                    SliverPadding(
                      ...
                      sliver: SliverList(
                        delegate: SliverChildBuilderDelegate(
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(model!.productDescriptionDTO!
                          ...
                          childCount:
                              model!.productDescriptionDTO!.options.length,
                        ),
                      ),
                    ),
                  ],
