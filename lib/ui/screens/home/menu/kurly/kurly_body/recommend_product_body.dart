...
class RecommendProductBody extends ConsumerStatefulWidget {
  const RecommendProductBody({
    Key? key,
  }) : super(key: key);

  @override
  ConsumerState<RecommendProductBody> createState() =>
      _RecommendProductBodyState();
}

class _RecommendProductBodyState extends ConsumerState<RecommendProductBody> {
  ...
  Widget build(BuildContext context) {
    ...
    List<ProductRandomMainDTO>? productStarProducts =
        productListModel?.productMainList?.productRandomMainDTOs;
    ...
    if (productListModel == null || categoryType == null) {
      ...
      return CustomScrollView(
        slivers: [
          ...
          SliverFillRemaining(
            child: RecommendProductList(
              categoryId: selectedCategory,
              productRecommendList: productListModel
                  ?.productMainList?.productRandomMainDTOs
