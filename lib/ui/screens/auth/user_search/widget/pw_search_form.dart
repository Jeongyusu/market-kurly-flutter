...
class PwSearchForm extends ConsumerWidget {
  final _formKey = GlobalKey<FormState>();
  final _username = TextEditingController();
  final _password = TextEditingController();

  PwSearchForm({Key? key}) : super(key: key);
      ...
      child: Column(
        children: [
          ...
          CustomLoginTextFormField(
            ...
            obscureText: false,
            funValidator: validateUserId(),
            controller: _username,
          ),
          const SizedBox(height: xsmallGap),
          CustomLoginTextFormField(
            placeholderText: "가입한 이메일을 입력해주세요",
            obscureText: true,
          ...
          CustomElevatedButton(
            ...
            funPageRoute: () {
              ...
              // }
              Navigator.pushNamed(context, Move.pwNewSetScreen);
            },
          ),
        ],
      ),
